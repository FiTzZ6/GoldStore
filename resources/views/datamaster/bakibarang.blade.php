...
<body>
    ...
    <div class="container">
                ...
                @foreach($baki as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('bakibarang.destroy', $item->kdbaki) }}" method="POST"
        ...
        <div id="suratResmi" class="surat-cetak" style="display:none;">
            ...
            <br>
            <p>Dengan hormat,</p>
            <p>Bersama ini kami sampaikan daftar baki yang ada dalam sistem:</p>
        ...
        <div id="modalHapus" class="modal">
            <div class="modal-content">
                ...
                <form action="{{ route('bakibarang.destroy', $item->kdbaki) }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
                    <button class="action-btn" onclick="return confirm('Yakin hapus?')"><i
        ...
        <script>
            ...
            // Fungsi export ke PDF hanya data terpilih
            function exportSelectedToPDF() {
                ...
                document.querySelectorAll(".rowCheckbox:checked").forEach(cb => {
                    ...
                    selectedRows.push({
                        kdbaki: cols[1].innerText,
                        namabaki: cols[2].innerText,
                        kdkategori: cols[3].innerText
                    });
                });

                if (selectedRows.length === 0) {
                    alert("Pilih minimal 1 data untuk di-print");
                    return;
                }

                // Tampilkan hanya data yang terpilih di surat resmi
                let tbody = document.querySelector("#suratResmi tbody");
                tbody.innerHTML = "";
        ...
        `;
            ...
            function handleExport(value) {
                ...
                if (value === "pdf") exportSelectedToPDF();
