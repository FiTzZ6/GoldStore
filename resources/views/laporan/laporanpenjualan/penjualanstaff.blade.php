...
<body>
    ...
    <div class="container">
        ...
        <div class="filters">
            ...
            <div class="filter-group">
                <label for="baki">FAKTUR</label>
                <select id="baki">
                    <option>SEMUA FAKTUR</option>
                    <option>FAKTUR 1</option>
                    <option>FAKTUR 2</option>
                </select>
            </div>
        </div>
        ...
        <div class="table-container">
            <table>
                <thead>
                    <tr>
                        <th>STAFF <i class="fas fa-sort"></i></th>
                        <th>Kategori <i class="fas fa-sort"></i></th>
                        <th>Faktur <i class="fas fa-sort"></i></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
